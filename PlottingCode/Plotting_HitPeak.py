...
#Plotting both hitpatterns and peaks
import random
import os
import datetime
import pytz
...
class PlottingHitPattern(PlotBase):
    ...
    def plot_event(self, event, show=('S1', 'S2'), show_dominant_array_only=False, subplots_to_use=None):
